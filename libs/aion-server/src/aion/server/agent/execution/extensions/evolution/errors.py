...
parsing), SetupError by tools_factory.py (behind the lazy import boundary).
Both terminate the routed task with a FAILED status carrying the message.
"""

from __future__ import annotations

__all__ = ["EvolutionHandlerError", "DirectiveError", "SetupError"]
...
class SetupError(EvolutionHandlerError):
