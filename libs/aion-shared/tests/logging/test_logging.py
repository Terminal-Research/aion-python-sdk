...
from aion.shared.logging.base import AionLogRecord, AionLogger
from aion.shared.logging.handlers.logstash import (
    AionLogstashFilter,
    AionLogstashFormatter,
)
from aion.shared.logging.handlers.stream import LogStreamFormatter, LogStreamHandler
...
class TestGetLogger:
    ...
    def test_is_logger_configured_false_for_new_logger(self):
        ...
        from aion.shared.logging.factory import _is_logger_configured
