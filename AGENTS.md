...
- **aion-chat-ui** – experimental standalone React/Ink terminal chat UI built with TypeScript and packaged for `aion-cli` as the `aion chat2` experience. Includes slash-command request/response mode controls with local persisted settings.
